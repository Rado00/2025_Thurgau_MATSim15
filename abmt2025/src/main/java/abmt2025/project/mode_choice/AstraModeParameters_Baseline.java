...
public class AstraModeParameters_Baseline extends SwissModeParameters {
	...
	static public AstraModeParameters_Baseline buildFrom6Feb2020() {
		AstraModeParameters_Baseline parameters = new AstraModeParameters_Baseline();
		...
		parameters.walk.alpha_u = 0.19; //--------
		parameters.bike.alpha_u = 5.1; //--------
		parameters.pt.alpha_u = -6.5; //--------
		parameters.car.alpha_u = 7.5; // Original from fb model: 0.2235;Horl 2021 -0.8 in the end
		parameters.astraCar.betaCity = -0.459; //--------
