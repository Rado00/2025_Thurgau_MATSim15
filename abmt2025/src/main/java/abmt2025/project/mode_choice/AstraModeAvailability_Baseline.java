...
public class AstraModeAvailability_Baseline implements ModeAvailability {
	public static final String NAME = "AstraModeAvailability_Baseline";

	private final SwissModeAvailability delegate;

	public AstraModeAvailability_Baseline(SwissModeAvailability delegate) {
