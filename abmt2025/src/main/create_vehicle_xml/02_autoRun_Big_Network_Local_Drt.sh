...
# Set paths
SHAPEFILE_PATH="$DATA_PATH/Paper2_ShapeFiles_CH1903+_LV95_easyNames/00_ShapeFile.shp"
INPUT_NETWORK="$DATA_PATH/MATSim_Thurgau/Baseline_Scenario_Fixed/100pct/network.xml.gz"
OUTPUT_NETWORK="$MAVEN_PATH/src/main/create_vehicle_xml/sim_network_w_DRT_area/00_network_wDRT.xml.gz"
