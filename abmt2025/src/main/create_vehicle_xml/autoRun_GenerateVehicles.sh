...
NETWORK_FILE="/home/muaa/2025_Thurgau_MATSim15/abmt2025/src/main/create_vehicle_xml/network/01_network.xml.gz"
NUM_VEHICLES=1000
T0=0
T1=86400
CAPACITY=4
OUTPUT_FILE="drt_vehicles.xml"

python generate_vehicles_from_network.py "$NETWORK_FILE" "$NUM_VEHICLES" "$T0" "$T1" "$CAPACITY" "$OUTPUT_FILE"
