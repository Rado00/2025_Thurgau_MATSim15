...
NETWORK_FILE="/home/muaa/2025_Thurgau_MATSim15/abmt2025/src/main/create_vehicle_xml/small_networks/01_network.xml.gz"
NUM_VEHICLES=2
T0=0
T1=86400
CAPACITY=8
OUTPUT_FILE="01_Fleet_files/01_drt_${NUM_VEHICLES}_${CAPACITY}.xml"
