...
# Set paths
SHAPEFILE_PATH="$DATA_PATH/Paper2_ShapeFiles_CH1903+_LV95/01_Weinfelden_Affeltrangen/01_Weinfelden_Affeltrangen.shp"
INPUT_NETWORK="$DATA_PATH/MATSim_Thurgau/Baseline_Scenario/100pct/network.xml.gz"
OUTPUT_NETWORK="$MAVEN_PATH/src/main/create_vehicle_xml/network/01_network.xml.gz"
