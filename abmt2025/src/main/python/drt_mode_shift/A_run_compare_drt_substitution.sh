...
# A_compare_drt_substitution.py on every (baseline, scenario) pair listed in
...
# ignored.
#
# Logic A: per-trip matching by (person, trip_number).
#
...
PYTHON_SCRIPT="$SCRIPT_DIR/A_compare_drt_substitution.py"
