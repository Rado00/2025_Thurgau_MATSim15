...
# B_compare_drt_od_match.py on every (baseline, scenario) pair listed in
...
# ignored.
#
# Logic B: OD-relaxed matching by (person, OD-key, time-bucket). See the
# python script docstring for the matching key precedence.
#
...
PYTHON_SCRIPT="$SCRIPT_DIR/B_compare_drt_od_match.py"
