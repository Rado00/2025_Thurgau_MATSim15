...
DRT_CONFIG="Thurgau_config_DRT_M15_06_swissRail_01.xml"
...
SIM_ID="SwissRail_04" # CHANGE TO RUN PARALLEL SIMS WITH DIFFERENT SETTINGS
FLEET_FILE="25_drt_1000_8.xml"
