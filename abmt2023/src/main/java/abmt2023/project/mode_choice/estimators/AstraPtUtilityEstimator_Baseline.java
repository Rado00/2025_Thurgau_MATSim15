...
public class AstraPtUtilityEstimator_Baseline extends PtUtilityEstimator {
	...
	@Inject
	public AstraPtUtilityEstimator_Baseline(AstraModeParameters_Baseline parameters, AstraPtPredictor predictor,
