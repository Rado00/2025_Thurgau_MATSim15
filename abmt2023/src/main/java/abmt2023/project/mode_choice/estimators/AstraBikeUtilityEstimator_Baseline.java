...
public class AstraBikeUtilityEstimator_Baseline extends SwissBikeUtilityEstimator {
	...
	@Inject
	public AstraBikeUtilityEstimator_Baseline(AstraModeParameters_Baseline parameters, AstraBikePredictor predictor,
