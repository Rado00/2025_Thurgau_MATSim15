...
public class AstraWalkUtilityEstimator_Baseline extends WalkUtilityEstimator {
	...
	@Inject
	public AstraWalkUtilityEstimator_Baseline(AstraModeParameters_Baseline parameters, AstraWalkPredictor predictor,
